...
export declare class GitRenderSchedulerAdapter {
    ...
    schedule(workspaceId: string, sourceId: string, run: () => Promise<GitRenderResult>, requestId?: string): import("../rendering/renderScheduler.js").ScheduledRender<GitRenderResult>;
