...
const childEnv = {
  ...
  VITE_USE_BACKEND_COLLABORATION:
    process.env.VITE_USE_BACKEND_COLLABORATION ?? 'true'
};

const interceptedFlags = warnIfNpmInterceptedFlags('dev');
if (interceptedFlags.length > 0) {
  process.exit(1);
}
